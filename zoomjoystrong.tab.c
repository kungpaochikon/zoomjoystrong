...
static const char *const yytname[] =
{
  ...
  "statement_list", "statement", "ex_line", "ex_point", "ex_circle",
  "ex_rectangle", "ex_set_color", YY_NULLPTR
};
#endif
...
static const yytype_uint8 yytable[] =
{
      ...
      17,    20,    21,    22,    23,    25,    24,    26,    27,    28,
      29,    31,    30,    32,    33,    34,    35,     0,     0,     0,
      19
};
...
#line 67 "zoomjoystrong.y" /* yacc.c:1646  */
  ...
  if((yyvsp[-3].i) + (yyvsp[-1].i) <= width && (yyvsp[-2].i) + (yyvsp[-1].i) <= height && (yyvsp[-3].i) - (yyvsp[-1].i) >= 0 && (yyvsp[-2].i) - (yyvsp[-1].i) >= 0){
...
#line 79 "zoomjoystrong.y" /* yacc.c:1646  */
  ...
  if((yyvsp[-4].i) >= 0 && (yyvsp[-3].i) >= 0 && (yyvsp[-4].i) + (yyvsp[-2].i) <= width && (yyvsp[-3].i) + (yyvsp[-1].i) <= height){
...
#line 1299 "zoomjoystrong.tab.c" /* yacc.c:1646  */
    break;
...
#line 102 "zoomjoystrong.y" /* yacc.c:1906  */
